...
import (
	...
	endpoint "github.com/ivost/hello_kit/pkg/endpoint"
	http1 "github.com/ivost/hello_kit/pkg/http"
	service "github.com/ivost/hello_kit/pkg/service"
...
var fs = flag.NewFlagSet("hello_kit", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("hello_kit", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
